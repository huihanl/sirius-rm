...
def get_shape_metadata_from_dataset(dataset_path, all_obs_keys=None, verbose=False, config=None):
    """
    ...
    for k in sorted(all_obs_keys):
        ...
        if k == "robot0_gripper_qpos" and config.train.use_gripper_history:
            all_shapes[k] = [10]
...
def algo_from_checkpoint(device=None, ckpt_path=None, ckpt_dict=None, verbose=False):
    """
