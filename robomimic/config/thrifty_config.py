...
class ThriftyConfig(BaseConfig):
    ALGO_NAME = "thrifty"
    ...
    def algo_config(self):
        ...
        """
        super(ThriftyConfig, self).algo_config()
        ...
        self.algo.optim_params.q1.learning_rate.initial = 1e-4      # policy learning rate
        self.algo.optim_params.q1.learning_rate.decay_factor = 0.1  # factor to decay LR by (if epoch schedule non-empty)
        self.algo.optim_params.q1.learning_rate.epoch_schedule = [] # epochs where LR decay occurs
        self.algo.optim_params.q1.regularization.L2 = 0.00          # L2 regularization strength

        self.algo.optim_params.q2.learning_rate.initial = 1e-4      # policy learning rate
        self.algo.optim_params.q2.learning_rate.decay_factor = 0.1  # factor to decay LR by (if epoch schedule non-empty)
        self.algo.optim_params.q2.learning_rate.epoch_schedule = [] # epochs where LR decay occurs
        self.algo.optim_params.q2.regularization.L2 = 0.00          # L2 regularization strength
        ...
        self.algo.hc_weights.weight_key = ""
        self.algo.hc_weights.mixed_weights = False
        self.algo.hc_weights.use_adv_score = False

        self.algo.hc_weights.demos = 1
        self.algo.hc_weights.rollouts = 1
        self.algo.hc_weights.intvs = 1
        self.algo.hc_weights.pre_intvs = 0.1

        self.algo.hc_weights.traj_label_type = "last"

        self.algo.hc_weights.batch_normalize = True
