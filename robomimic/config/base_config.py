...
class BaseConfig(Config):
    ...
    def experiment_config(self):
        ...
        self.experiment.render_video = False                         # render evaluation rollouts to videos
        ...
        self.experiment.rollout.warmstart = 250                     # number of epochs to wait before starting rollouts
        self.experiment.rollout.terminate_on_success = True         # end rollout early after task success
        self.experiment.rollout.parallel_envs = 1 # default
    ...
    def train_config(self):
        ...
        # whether to use iwr sampling
        self.train.use_iwr_sampling = False
        self.train.use_weighted_sampling = False
        self.train.bootstrap_sampling = False
        ...
        # number of demos (default is full dataset)
        self.train.num_eps = None
        self.train.sort_demo_key = None
        self.train.use_gripper_history = False

        self.train.classifier_relabeling.enabled = False
        self.train.classifier_relabeling.ckpt_path = None
        self.train.classifier_relabeling.filter_key = None
        self.train.classifier_relabeling.label_rollout_only = True
        self.train.classifier_relabeling.label_key = "intv_labels"
        self.train.classifier_relabeling.relabel_strategy = "intv"
        self.train.classifier_relabeling.traj_label_type = "last"
        self.train.classifier_relabeling.cls_threshold = 1

        # pseudo labeling

        self.train.classifier_relabeling.pseudo_labling = False
        self.train.classifier_relabeling.demos_drop_th = 0
        self.train.classifier_relabeling.intv_drop_th = 0
        self.train.classifier_relabeling.preintv_drop_th = 0
        self.train.classifier_relabeling.rollout_demos_drop = 0
        self.train.classifier_relabeling.rollout_intvs_drop = 0
        self.train.classifier_relabeling.rollout_preintvs_drop = 0

        # default always accept predicted label
        
        self.train.preintv_relabeling.enabled = False
        self.train.preintv_relabeling.mode = 'fixed'
        self.train.preintv_relabeling.fixed_preintv_length = 15
        self.train.preintv_relabeling.model_ckpt = None
        self.train.preintv_relabeling.model_th = -0.30
        self.train.preintv_relabeling.model_eval_mode = 'V'
        self.train.preintv_relabeling.base_key = 'action_modes'

        self.train.novelty_relabeling.enabled = False
        self.train.novelty_relabeling.model_ensemble_ckpts = []
        self.train.novelty_relabeling.novelty_region = 15
        self.train.novelty_relabeling.relabel_strategy = "only_succ_rollout"

        self.train.use_sampler = True
    ...
    def algo_config(self):
        ...
        """
        self.algo.hc_weights.enabled = False
        self.algo.hc_weights.weight_key = "intv_labels"
        self.algo.hc_weights.normalize = False
        self.algo.hc_weights.demos = 10
        self.algo.hc_weights.rollouts = 1
        self.algo.hc_weights.intvs = 10
        self.algo.hc_weights.pre_intvs = 0.1
        self.algo.hc_weights.traj_label_type = "last"
        self.algo.hc_weights.use_weighted_sampler = False
        self.algo.hc_weights.use_iwr_ratio = False
        self.algo.hc_weights.iwr_ratio_adjusted = False
        self.algo.hc_weights.action_mode_selection = 0
        self.algo.hc_weights.same_weight_for_seq = False
        self.algo.hc_weights.use_category_ratio = False
        self.algo.hc_weights.prenormalize_weights = False
        self.algo.hc_weights.give_final_percentage = False
        self.algo.hc_weights.ours_percentage = False
        self.algo.hc_weights.delete_rollout_ratio = -1
        self.algo.hc_weights.memory_org_type = None
        self.algo.hc_weights.not_use_preintv = False

        """ Upweight last round """
        self.algo.hc_weights.diff_weights_diff_rounds = False
        self.algo.hc_weights.rounds_key = "round"
        self.algo.hc_weights.round_upweights = { 4 : 1.2 }
        self.algo.hc_weights.normalize_after_round_upweight = False
        self.algo.hc_weights.rounds_resampling = False

        """ Resampling """
        self.algo.hc_weights.resampling_weight = 10 # Upsampling weight for last round

        self.algo.remove_intervention_sampler = False
    ...
    def observation_config(self):
        ...
        self.observation.modalities.obs.rgb2 = []
        ...
        # rgb2 (for different image size)
        self.observation.encoder.rgb2.core_class = "VisualCore"
        self.observation.encoder.rgb2.core_kwargs.feature_dimension = 64
        self.observation.encoder.rgb2.core_kwargs.flatten = True
        self.observation.encoder.rgb2.core_kwargs.backbone_class = "ResNet18Conv"
        self.observation.encoder.rgb2.core_kwargs.backbone_kwargs.pretrained = False
        self.observation.encoder.rgb2.core_kwargs.backbone_kwargs.input_coord_conv = False
        self.observation.encoder.rgb2.core_kwargs.backbone_kwargs.do_not_lock_keys()
        self.observation.encoder.rgb2.core_kwargs.pool_class = "SpatialSoftmax"                # Alternate options are "SpatialMeanPool" or None (no pooling)
        self.observation.encoder.rgb2.core_kwargs.pool_kwargs.num_kp = 32                      # Default arguments for "SpatialSoftmax"
        self.observation.encoder.rgb2.core_kwargs.pool_kwargs.learnable_temperature = False    # Default arguments for "SpatialSoftmax"
        self.observation.encoder.rgb2.core_kwargs.pool_kwargs.temperature = 1.0                # Default arguments for "SpatialSoftmax"
        self.observation.encoder.rgb2.core_kwargs.pool_kwargs.noise_std = 0.0                  # Default arguments for "SpatialSoftmax"
        self.observation.encoder.rgb2.core_kwargs.pool_kwargs.output_variance = False          # Default arguments for "SpatialSoftmax"
        self.observation.encoder.rgb2.core_kwargs.pool_kwargs.do_not_lock_keys()

        # rgb2: Obs Randomizer settings
        self.observation.encoder.rgb2.obs_randomizer_class = None                  # Can set to 'CropRandomizer' to use crop randomization
        self.observation.encoder.rgb2.obs_randomizer_kwargs.crop_height = 76       # Default arguments for "CropRandomizer"
        self.observation.encoder.rgb2.obs_randomizer_kwargs.crop_width = 76        # Default arguments for "CropRandomizer"
        self.observation.encoder.rgb2.obs_randomizer_kwargs.num_crops = 1          # Default arguments for "CropRandomizer"
        self.observation.encoder.rgb2.obs_randomizer_kwargs.pos_enc = False        # Default arguments for "CropRandomizer"
        self.observation.encoder.rgb2.obs_randomizer_kwargs.do_not_lock_keys()
